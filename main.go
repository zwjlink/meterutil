...
var (
	...
	ToAddress      = meter.MustParseAddress("0x6a797722f929e24eac9acF8b9fFa74346dB3167c")
	TestPrivateKey = "fc9acf86d3fb3eed9a739022b267aa5f81982d44d7f12fafe9d754c5497ac0c6" //  hex string without leading 0x
)
...
func sendTx(blockRef uint32) {
	...
	res := httpPost("http://warringstakes.meter.io:86691/transactions", RawTx{Raw: hexutil.Encode(rlpTx)})
